    ...
    <aside className={styles.sidebar} {...props}>
      ...
      <div className="flex justify-between gap-4 p-12">
        <div className="flex flex-col items-center">
          <IconButton icon={<MdBookmark style={{color: "#367588", fontSize: 24}}/>}/>
          <p className="font-jest" style={{fontSize: 16}}>Favorites</p>
        </div>
        <div className="flex flex-col items-center">
          <IconButton icon={<MdNotifications style={{color: "#D56277", fontSize: 24}}/>}/>
          <p className="font-jest" style={{fontSize: 16}}>Notifications</p>
        </div>
        <div className="flex flex-col items-center">
          <IconButton icon={<SettingFilled style={{color: "#C1BC7D", fontSize: 20}}/>}/>
          <p className="font-jest" style={{fontSize: 16}}>Settings</p>
        </div>
      </div>
    </aside>
  );
